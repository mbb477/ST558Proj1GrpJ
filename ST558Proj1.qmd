...
It looks like there may be some outliers in this data. We will investigate by filtering data for the counties of Kings, Queens and Bronx in 1992.
...
We can see that the population for Kings, NY is unusually high, while Bronx, New York and Queens counties are zero. The correct information can be found in this document, <https://www2.census.gov/programs-surveys/popest/tables/1990-2000/intercensal/st-co/co-est2001-12-36.pdf>. We will replace the incorrect data in the original list and rerun our county plot function.
