...
need to first remove error rows (United States)

change division to factor
...
piecing function together:

```{r}
#| eval: false
state.plot <- function(df, default_var_name = "enrollment") {
  result <- df[[2]] |>
    filter(area_name != "UNITED STATES") |> 
    group_by(division)
...
# Putting it Together (need a better name)

## EDU Data Sets 

### Data Processing Function for EDU Data Sets

### Data Combining Function for EDU Data Sets

### State Plot Function for EDU Data Sets

### County Plot Function for EDU Data Sets

## PST  Data sets

### Data Processing Function for PST Data Sets

### Data Combining Function for PST Data Sets

### State Plot Function for PST Data Sets

### County Plot Function for PST Data Sets
